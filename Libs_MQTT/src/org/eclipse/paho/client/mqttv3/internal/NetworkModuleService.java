...
public class NetworkModuleService {
	...
	public static final List<NetworkModuleFactory> factories;
	static {
		factories = Arrays.asList(new WebSocketNetworkModuleFactory(), new WebSocketSecureNetworkModuleFactory(), new TCPNetworkModuleFactory(), new SSLNetworkModuleFactory());
	}
	...
	public static void validateURI(String brokerUri) throws IllegalArgumentException {
		try {
			...
			synchronized (FACTORY_SERVICE_LOADER) {
				for (NetworkModuleFactory factory : factories) {
