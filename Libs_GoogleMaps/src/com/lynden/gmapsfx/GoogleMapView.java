...
public class GoogleMapView extends AnchorPane {
        ...
        Runnable initWebView = () -> {
            try {
                ...
                webengine.setOnAlert(new EventHandler<WebEvent<String>>() {
                    @Override
                    public void handle(WebEvent<String> e) { //b4j
                    	if ("!!!mapLibraryLoaded!!!".equals(e.getData())) {
                    		bridge.mapLibraryLoaded();
                    	}
                ...
                webview.getEngine().locationProperty().addListener(new ChangeListener<String>() {
        			...
        			public void changed(ObservableValue<? extends String> arg0,
        				...
        				if (arg2.contains("google.com")) {
        					System.out.println("Resetting map (" + arg2 + ")");//b4j change
    ...
    private MapLibraryLoadBridge bridge;
    private void initialiseScript() {
        if (!usingCustomHtml) {
            JSObject window = (JSObject) webengine.executeScript("window");
            bridge = new MapLibraryLoadBridge();
            window.setMember("libLoadBridge", bridge); //b4j
    ...
    public class MapLibraryLoadBridge {
        ...
        public void mapLibraryLoaded() {
        	System.out.println("mapLibraryLoaded!");
            setInitialized(true);
            fireMapInitializedListeners();
        }
